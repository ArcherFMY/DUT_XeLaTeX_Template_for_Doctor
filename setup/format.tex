...
\fancyhf{}
\fancyhead[CO]{\song\wuhao{大连理工大学博士学位论文}}
...
\captiondelim{\hspace{1em}}
\captionnamefont{\hei \xiaosi}%字体改为黑体
\captiontitlefont{\hei \xiaosi}
%\captionnamefont{\hei \zhongwu}%字体改为黑体小四
%\captiontitlefont{\hei \zhongwu}
