...
\begin{figure}[htbp]
  ...
  \bicaption[fig:sun]{图}{最左侧是太阳，向右依序为水星、金星、地球、火星、
    木星、土星、天王星与海王星}{Figure}{Outward from the Sun, the planets
...
\begin{table}[htbp]
  \bicaption[tab:xingxing]{表}{行星数据表}{Table}{Planet}
  \centering
  \vspace{0.2cm}
  \zhongwu
  \begin{tabular}{cccc}
...
它的官方使用说明为：
\begin{lstlisting}
  \bicaption[label]{ 中文短标题 }{ 中文标题 }{Table}{ 英文标题 }
\end{lstlisting}
...
\begin{table}[htbp]
  \bicaption[tab:xiaoshu]{表}{行星数据表}{Table}{Planet}
  \centering
  \vspace{0.2cm}
  \zhongwu
  \begin{tabular}{lcSr}
...
\begin{table}[htbp]
  \bicaption[tab:linux]{}{ 不同操作系统下的\LaTeX{} }{Table}{OS with \LaTeX{}}
  \centering
  \vspace{0.2cm}
  \zhongwu
  \begin{tabular}{ccc}
...
\begin{table}[htbp]
  \bicaption[tab:unix]{}{ 不同操作系统下的\LaTeX{} }{Table}{OS with \LaTeX{}}
  \centering
  \vspace{0.2cm}
  \zhongwu
  \begin{tabular}{ccc}
...
\begin{table}[htbp]
  \centering
  \bicaption[tab:wall]{ 表 }{ 墙上的44句话 }{Table}{Mikko Kuorinki}
  \vspace{0.2cm}
  \zhongwu
...
\begin{lstlisting}
  \begin{table}[htbp]
    \centering
    \bicaption[tab:figure]{ 表 }{ 墙上的44句话 }{Table}{Mikko Kuorinki}
    \vspace{0.2cm}
    \zhongwu
    \begin{tabularx}{0.8\textwidth{}}{lX}
      \toprule
...
\begin{table}[htbp]
  \bicaption[tab:diagbox]{表}{斜线表头}{Table}{Diagbox}
  \centering
  \vspace{0.2cm}
  \zhongwu
  \begin{tabular}{|l|ccc|}
...
\begin{table}[htbp]
  \bicaption[tab:xiexian]{ 表 }{斜线表头}{Table}{Diagbox}
  \centering
  \vspace{0.2cm}
  \zhongwu
  \begin{tabular}{|l|ccc|}
...
\begin{figure}[htbp]
  ...
  \bicaption[fig:wedding]{婚礼}{婚礼}{Figure}{Wedding}
\end{figure}
...
\begin{table}[htbp]
  \centering
  \bicaption[tab:figure]{插图命令参数}{插图命令参数}{Table}{Parameter}
  \vspace{0.2cm}
  \zhongwu
  \begin{tabularx}{0.8\textwidth{}}{lX}
    \toprule
...
\begin{lstlisting}
  \begin{figure}[htbp]
    ...
    \bicaption[fig:sun]{ 图 }{ 最左侧是太阳，向右依序为水星、金
      星 }{Figure}{Outward from the Sun, the planets are Mercury, Venus,
...
\begin{figure}[htbp]
  ...
  \begin{minipage}{0.4\textwidth}
    ...
    \bicaption[fig:lang]{图}{新郎}{Figure}{Bridegroom}
  \end{minipage}
  \begin{minipage}{0.4\textwidth}
    \centering
    \includegraphics[keepaspectratio]{liang.jpg}
    \bicaption[fig:niang]{图}{新娘}{Figure}{Brige}
  \end{minipage}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \bicaption[fig:judy]{图}{小超人老师}{Figure}{Judy}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \bicaption[fig:boxingtu]{波形图}{波形图}{Figure}{Wave}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \bicaption[fig:bahe]{巴赫手稿}{巴赫手稿}{Figure}{Partita No.3}
\end{figure}
